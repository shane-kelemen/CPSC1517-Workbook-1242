...
//        => optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=WestWind;Integrated Security=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BuildVer__3214EC07E193A379");
        ...
        {
            entity.HasKey(e => e.ManifestItemID).HasName("PK__Manifest__9000192C70FD43B9");
        ...
        {
            entity.HasKey(e => e.ShipmentID).HasName("PK__Shipment__5CAD378DE83D0AFE");
